...
set extName=window_get_active_title
set dllName=window_get_active_title
set gmlDir14=%solutionDir%window_get_active_title.gmx
set gmlDir22=%solutionDir%window_get_active_title_yy
set gmlDir23=%solutionDir%window_get_active_title_23
